...
public class LFnC {
    ...
    public static final String weatherPath =
        "/xml/sample_products/browser_interface/ndfdXMLclient.php";
    public static final String timeLayoutKey_tag = "layout-key"; // tag for the
                                                                 // key to a
                                                                 // time
                                                                 // particular
                                                                 // time layout
    public static final String timeLayout_tag = "time-layout"; // tag for the a
                                                               // time-layout
